...
class Application(models.Model):
    COURSES = (
        ...
        ('Masters of Computer Applications', 'Masters of Computer Applications'),
    )
    ...
    aadhar_card_number = models.CharField(max_length=12, null=True, blank=True, verbose_name="Aadhar Card Number")
    aadhar_card = models.ImageField(upload_to="images", null=True, blank=True, verbose_name="Aadhar Card Image")
